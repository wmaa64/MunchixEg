...
<>
  ...
  <div className="featured-products" dir={isRTL ? "rtl" : "ltr"}>
    <div className="products-heading">
      <h2> {isRTL ? "الساندويتشات المميزة" : "Featured Sandwitches"} </h2>
    </div>

    { (loading) ? (
        <p>{isRTL ? "جارٍ تحميل المنتجات..." : "Loading products..."}</p>
      ) : (
        <div className="products-container">
          {(products.length > 0) ? 
            (products.map((product) => (
              ...
              <p>{isRTL ? "لا توجد منتجات مميزة متاحة." : "No featured products available."}</p>
            )
          }
        </div>
        ) 
